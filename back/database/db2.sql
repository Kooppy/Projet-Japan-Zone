...
CREATE TABLE IF NOT EXISTS `test`.`tags` (
  ...
  `culture` TINYINT NOT NULL DEFAULT 0,
  `cosplay` TINYINT NOT NULL DEFAULT 0,
  `gaming` TINYINT NOT NULL DEFAULT 0,
  `technology` TINYINT NOT NULL DEFAULT 0,
  `board_games` TINYINT NOT NULL DEFAULT 0,
