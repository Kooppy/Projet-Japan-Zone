...
exports.blog = async (req, res) => {
    ...
    try {
        const blog = await db.query(`SELECT blog.num_blog, blog.title, blog.description, blog.contents, blog.date, pictureBank.link_picture, tags.name
                                     FROM blog 
...
exports.blogID = async (req, res) => {
    ...
    try {
        const blog = await db.query(`SELECT blog.num_blog, blog.title, blog.description, blog.contents, blog.date, user.pseudo, pictureBank.link_picture, tags.name
                                     FROM blog 
